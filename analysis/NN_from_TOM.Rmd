...
```
#### Some functions in this file are from the [WGNCA library (version 1.63)](https://cran.r-project.org/web/packages/WGCNA/index.html). I opted to include them here rather than require you to install WGCNA
```{r source functions}
