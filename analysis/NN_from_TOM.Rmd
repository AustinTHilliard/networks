...
```
#### Some functions in [NN_from_TOM_functions.R](https://github.com/AustinTHilliard/networks/blob/master/code/NN_from_TOM_functions.R) are from the [WGNCA library (version 1.63)](https://cran.r-project.org/web/packages/WGCNA/index.html). I included them here rather than require you to install WGCNA  
